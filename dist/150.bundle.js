"use strict";
(self["webpackChunkrestaurant_apps"] = self["webpackChunkrestaurant_apps"] || []).push([[150],{
...
var AxiosError = __webpack_require__(333);
...
var toFormData = __webpack_require__(238);
// EXTERNAL MODULE: ./node_modules/axios/lib/helpers/toURLEncodedForm.js
var toURLEncodedForm = __webpack_require__(856);
// EXTERNAL MODULE: ./node_modules/axios/lib/platform/browser/index.js + 3 modules
var browser = __webpack_require__(160);
// EXTERNAL MODULE: ./node_modules/axios/lib/helpers/formDataToJSON.js
var formDataToJSON = __webpack_require__(510);
...
const defaults = {
  ...
  transformRequest: [function transformRequest(data, headers) {
    ...
    if (isFormData) {
      ...
      return hasJSONContentType ? JSON.stringify((0,formDataToJSON/* default */.Z)(data)) : data;
    }

    if (utils/* default */.Z.isArrayBuffer(data) ||
      utils/* default */.Z.isBuffer(data) ||
      utils/* default */.Z.isStream(data) ||
      utils/* default */.Z.isFile(data) ||
      utils/* default */.Z.isBlob(data)
    ) {
      return data;
    }
    ...
    if (isObjectPayload) {
      if (contentType.indexOf('application/x-www-form-urlencoded') > -1) {
        return (0,toURLEncodedForm/* default */.Z)(data, this.formSerializer).toString();
      }

      if ((isFileList = utils/* default */.Z.isFileList(data)) || contentType.indexOf('multipart/form-data') > -1) {
        const _FormData = this.env && this.env.FormData;

        return (0,toFormData/* default */.Z)(
  ...
  env: {
    FormData: browser/* default */.Z.classes.FormData,
    Blob: browser/* default */.Z.classes.Blob
  },
...
// EXTERNAL MODULE: ./node_modules/axios/lib/helpers/parseHeaders.js
...
class AxiosHeaders {
  ...
  set(header, valueOrRewrite, rewrite) {
    ...
    const setHeaders = (headers, _rewrite) =>
      utils/* default */.Z.forEach(headers, (_value, _header) => setHeader(_value, _header, _rewrite));
    ...
    if (utils/* default */.Z.isPlainObject(header) || header instanceof this.constructor) {
      ...
      setHeaders((0,parseHeaders/* default */.Z)(header), valueOrRewrite);
    } else {
...
utils/* default */.Z.reduceDescriptors(AxiosHeaders.prototype, ({value}, key) => {
...
function CanceledError(message, config, request) {
  ...
  AxiosError/* default */.Z.call(this, message == null ? 'canceled' : message, AxiosError/* default */.Z.ERR_CANCELED, config, request);
  this.name = 'CanceledError';
}

utils/* default */.Z.inherits(CanceledError, AxiosError/* default */.Z, {
  __CANCEL__: true
});
...
var helpers_null = __webpack_require__(198);
...
function settle(resolve, reject, response) {
  ...
  if (!response.status || !validateStatus || validateStatus(response.status)) {
    ...
    reject(new AxiosError/* default */.Z(
      'Request failed with status code ' + response.status,
      [AxiosError/* default */.Z.ERR_BAD_REQUEST, AxiosError/* default */.Z.ERR_BAD_RESPONSE][Math.floor(response.status / 100) - 4],
      response.config,
      response.request,
      response
    ));
...
// EXTERNAL MODULE: ./node_modules/axios/lib/helpers/cookies.js
var cookies = __webpack_require__(308);
// EXTERNAL MODULE: ./node_modules/axios/lib/helpers/isAbsoluteURL.js
var isAbsoluteURL = __webpack_require__(474);
// EXTERNAL MODULE: ./node_modules/axios/lib/helpers/combineURLs.js
...
function buildFullPath(baseURL, requestedURL) {
  if (baseURL && !(0,isAbsoluteURL/* default */.Z)(requestedURL)) {
    return (0,combineURLs/* default */.Z)(baseURL, requestedURL);
  }
  return requestedURL;
}

// EXTERNAL MODULE: ./node_modules/axios/lib/helpers/isURLSameOrigin.js
var isURLSameOrigin = __webpack_require__(738);
// EXTERNAL MODULE: ./node_modules/axios/lib/helpers/parseProtocol.js
var parseProtocol = __webpack_require__(312);
// EXTERNAL MODULE: ./node_modules/axios/lib/helpers/speedometer.js
var speedometer = __webpack_require__(141);
...
/* harmony default export */ const xhr = (isXHRAdapterSupported && function (config) {
  return new Promise(function dispatchXhrRequest(resolve, reject) {
    ...
    if (utils/* default */.Z.isFormData(requestData)) {
      if (browser/* default */.Z.isStandardBrowserEnv || browser/* default */.Z.isStandardBrowserWebWorkerEnv) {
        requestHeaders.setContentType(false); // Let the browser set it
      } else if(!requestHeaders.getContentType(/^\s*multipart\/form-data/)){
        requestHeaders.setContentType('multipart/form-data'); // mobile/desktop app frameworks
      } else if(utils/* default */.Z.isString(contentType = requestHeaders.getContentType())){
    ...
    request.ontimeout = function handleTimeout() {
      ...
      reject(new AxiosError/* default */.Z(
        timeoutErrorMessage,
        transitional.clarifyTimeoutError ? AxiosError/* default */.Z.ETIMEDOUT : AxiosError/* default */.Z.ECONNABORTED,
        config,
        request));
    ...
    if (browser/* default */.Z.isStandardBrowserEnv) {
      // Add xsrf header
      const xsrfValue = (config.withCredentials || (0,isURLSameOrigin/* default */.Z)(fullPath))
        && config.xsrfCookieName && cookies/* default */.Z.read(config.xsrfCookieName);
    ...
    if (protocol && browser/* default */.Z.protocols.indexOf(protocol) === -1) {
...
const isResolvedHandle = (adapter) => utils/* default */.Z.isFunction(adapter) || adapter === null || adapter === false;
...
/* harmony default export */ const adapters = ({
  getAdapter: (adapters) => {
    ...
    for (let i = 0; i < length; i++) {
      ...
      if (!isResolvedHandle(nameOrAdapter)) {
        ...
        if (adapter === undefined) {
          throw new AxiosError/* default */.Z(`Unknown adapter '${id}'`);
        }
      }
    ...
    if (!adapter) {
      ...
      throw new AxiosError/* default */.Z(
...
function mergeConfig(config1, config2) {
  ...
  function getMergedValue(target, source, caseless) {
    if (utils/* default */.Z.isPlainObject(target) && utils/* default */.Z.isPlainObject(source)) {
      return utils/* default */.Z.merge.call({caseless}, target, source);
...
const validators = validator/* default */.Z.validators;
...
class Axios {
  ...
  request(configOrUrl, config) {
    ...
    if (transitional !== undefined) {
      validator/* default */.Z.assertOptions(transitional, {
    ...
    if (paramsSerializer != null) {
      if (utils/* default */.Z.isFunction(paramsSerializer)) {
        ...
        validator/* default */.Z.assertOptions(paramsSerializer, {
    ...
    // Flatten headers
    let contextHeaders = headers && utils/* default */.Z.merge(
      headers.common,
      headers[config.method]
    );

    headers && utils/* default */.Z.forEach(
...
function createInstance(defaultConfig) {
  ...
  const instance = (0,bind/* default */.Z)(core_Axios.prototype.request, context);

  // Copy axios.prototype to instance
  utils/* default */.Z.extend(instance, core_Axios.prototype, context, {allOwnKeys: true});

  // Copy context to instance
  utils/* default */.Z.extend(instance, context, null, {allOwnKeys: true});
...
axios.spread = spread/* default */.Z;

// Expose isAxiosError
axios.isAxiosError = isAxiosError/* default */.Z;
...
axios.formToJSON = thing => (0,formDataToJSON/* default */.Z)(utils/* default */.Z.isHTMLForm(thing) ? new FormData(thing) : thing);

axios.getAdapter = adapters.getAdapter;

axios.HttpStatusCode = HttpStatusCode/* default */.Z;
