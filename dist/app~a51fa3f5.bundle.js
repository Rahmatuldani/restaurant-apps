...
/* harmony import */ var _global_config__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(736);
...
var DATABASE_NAME = _global_config__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z.DATABASE_NAME,
  DATABASE_VERSION = _global_config__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z.DATABASE_VERSION,
  OBJECT_STORE_NAME = _global_config__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z.OBJECT_STORE_NAME;
    ...
    return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
      ...
      return _regeneratorRuntime().wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          ...
          case 2:
            data = _context5.sent;
            return _context5.abrupt("return", data.filter(function (restaurant) {
...
__webpack_require__.d(__webpack_exports__, {
  Z: () => (/* binding */ restaurantSource)
});

// EXTERNAL MODULE: ./node_modules/axios/lib/axios.js + 15 modules
var axios = __webpack_require__(150);
// EXTERNAL MODULE: ./src/scripts/global/config.js
var config = __webpack_require__(736);
;// CONCATENATED MODULE: ./src/scripts/global/api-endpoint.js

var API_ENDPOINT = {
  GET_ALL: "".concat(config/* default */.Z.BASE_URL, "list"),
  SEARCH: function SEARCH(query) {
    return "".concat(config/* default */.Z.BASE_URL, "search?q=").concat(query);
  },
  DETAIL: function DETAIL(id) {
    return "".concat(config/* default */.Z.BASE_URL, "detail/").concat(id);
  },
  ADD_REVIEW: "".concat(config/* default */.Z.BASE_URL, "review")
};
...
var RestaurantSource = /*#__PURE__*/function () {
  ...
  _createClass(RestaurantSource, null, [{
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              _context.next = 3;
              return axios/* default */.Z.get(api_endpoint.GET_ALL);
            case 3:
    ...
    value: function () {
      var _searchRestaurants = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(query) {
        var response;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              _context2.prev = 0;
              _context2.next = 3;
              return axios/* default */.Z.get(api_endpoint.SEARCH(query));
            case 3:
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              _context3.prev = 0;
              _context3.next = 3;
              return axios/* default */.Z.get(api_endpoint.DETAIL(id));
            case 3:
    ...
    key: "addReview",
    value: function () {
      var _addReview = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(body) {
        var response;
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              _context4.prev = 0;
              _context4.next = 3;
              return axios/* default */.Z.post(api_endpoint.ADD_REVIEW, body);
            case 3:
              response = _context4.sent;
              return _context4.abrupt("return", {
                code: 'success',
                data: response.data.customerReviews
              });
            case 7:
              _context4.prev = 7;
...
/* harmony default export */ const restaurantSource = (RestaurantSource);
...
/* harmony import */ var _views_app__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(685);
  ...
  return _regeneratorRuntime().wrap(function _callee$(_context) {
    while (1) switch (_context.prev = _context.next) {
      case 0:
        app.renderPage();
        _context.next = 3;
        return (0,_utils_sw_register__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .Z)();
      case 3:
      case "end":
        return _context.stop();
    }
